...
class CirrusSdk < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://gitlab.galvanize.com/api/v4/projects/4178/packages/generic/cirrus-sdk-releases/v2.1.6/cirrus-sdk-darwin-arm64.tar.gz"
    ...
    if Hardware::CPU.intel?
      url "https://gitlab.galvanize.com/api/v4/projects/4178/packages/generic/cirrus-sdk-releases/v2.1.6/cirrus-sdk-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel? and Hardware::CPU.is_64_bit?
      url "https://gitlab.galvanize.com/api/v4/projects/4178/packages/generic/cirrus-sdk-releases/v2.1.6/cirrus-sdk-linux-amd64.tar.gz"
